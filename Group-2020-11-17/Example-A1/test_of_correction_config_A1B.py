...
def main(example_name, mesh_config, export_filename):
    t0 = time.time()
    zone_xl, zone_xr = 0, 1
    zone_yl, zone_yr = 0, 2
...
if __name__ == "__main__":
    # 基础配置
    # meshtype          # 网格单元配置名 options: 0, 1, 2, 3, 4
    ...
    args = arg.parse_args()
    configs = [(4, 8, 0.25), (8, 16, 0.125), (16, 32, 0.0625), (32, 64, 0.03125), (64, 128, 0.015625)]
    example_name = "example-A1B-attenuate"
    export_filename = example_name + ".out"
    nx, ny, grid_size = configs[args.mtype]
    main(example_name, (nx, ny, grid_size), export_filename)
