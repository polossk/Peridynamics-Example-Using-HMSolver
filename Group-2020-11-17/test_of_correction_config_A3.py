...
def main(example_name, mesh_file_name, cname, export_filename):
    ...
    inner_hole_radius_1, inner_hole_radius_2 = 0.1, 0.15
    total_area = (zone_yr - zone_yl) * (zone_xr - zone_xl)
    total_area -= np.pi * inner_hole_radius_1 * inner_hole_radius_2
...
if __name__ == "__main__":
    ...
    example_name = f"example-A3{c}-{cname}"
    mesh_file_name = f"A3{args.mtype}.mesh"
